    ...
    <body class="cbp-spmenu-push">
        ...
        @endsection
            ...
            <div id="page-wrapper">
                <div class="main-page">
                    <div class="forms">
                        <h2 class="title1">Sub Category Form</h2>
                        ...
                        <div class=" form-grids row form-grids-right">
                            <div class="widget-shadow " data-example-id="basic-forms"> 
                                ...
                                <div class="form-body">
                                    <form method="post" action="{{ route('subcategory.store')}}" class="form-horizontal">
                                    @csrf
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">SubCategory Name:</label> 
                                            <div class="col-sm-9"> 
                                                <input type="text" class="form-control" id="inputEmail3" name="subcat_name" placeholder="Enter Sub Category" required>
                                            </div>
                                        </div> 
                                        <div class="form-group">
