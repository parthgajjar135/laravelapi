...
@section('style')
        ...
        <title>Sub Category Database Table</title>
...
<tbody>
    ...
    <tr>
        ...
        <td>{{$product->subcat_active}}</td>
        <td><a href="{{ route('subcategory.edit',$product->subcat_id)}}"> Edit </a> | 
        
            <form action="{{ route('subcategory.destroy', $product->subcat_id)}}" method="post" >
                @csrf
                @method('DELETE')
